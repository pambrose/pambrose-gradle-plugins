...
Replace `Tag` with a GitHub release tag (e.g., `1.0.10`), a short commit hash, or `main-SNAPSHOT` for the latest commit
on `main`.
...
```kotlin
plugins {
  id("com.pambrose.envvar") version "1.0.10"
  id("com.pambrose.stable-versions") version "1.0.10"
  id("com.pambrose.kotlinter") version "1.0.10"
  id("com.pambrose.publishing") version "1.0.10"
  id("com.pambrose.repos") version "1.0.10"
  id("com.pambrose.snapshot") version "1.0.10"
  id("com.pambrose.testing") version "1.0.10"
}
```
...
```kotlin
plugins {
  id("com.pambrose.envvar") version "1.0.10" apply false
  id("com.pambrose.stable-versions") version "1.0.10" apply false
  id("com.pambrose.kotlinter") version "1.0.10" apply false
  id("com.pambrose.publishing") version "1.0.10" apply false
  id("com.pambrose.repos") version "1.0.10" apply false
  id("com.pambrose.snapshot") version "1.0.10" apply false
  id("com.pambrose.testing") version "1.0.10" apply false
}
```
